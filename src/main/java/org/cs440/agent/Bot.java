    ...
    public void bot1() {
        ...
        if (moveQueue.isEmpty()) {
            ...
            if (target.capture(x, y)) {
                ...
                App.logger.debug("Bot " + identifier + " captured target " + ((Agent)target).identifier());
                App.logger.debug("Captured target in " + moveCount + " moves and " + senseCount + " senses for a total of " + (moveCount + senseCount) + " actions.");
